...
<div style="margin-left: 300px;">
		<form action="depotrans.jsp" method="post">
			<div class="container">
				<center>
					<h1 style="font-size: 50px;">- DEPOSIT -</h1>
				</center>
				<hr>
				<label> <b>Username</b>
                ...
                <label> 
                    <b>Amount Deposit</b><br>
				</label> 
                <input type="number" name="deposit" placeholder="Amount Deposit" required> 
