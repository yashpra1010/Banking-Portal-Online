...
//JDBC-connection
	...
	int depo = Integer.parseInt(request.getParameter("deposit"));
	...
	String UpdateQ = "UPDATE `transaction` SET deposit = ?, balance = ?,withdraw=0 WHERE username=?;";
